...
CollectItem::CollectItem(double x, double y,bool canBeCollected) : x(x), y(y), startY(y), canBeCollected(canBeCollected){
    ...
    switch(id){
        case 1:
            texture.loadFromFile("Sprites/UI/EmptyHealth.png");
            break;
        case 2:
            texture.loadFromFile("Sprites/UI/FullHealth.png");
            break;
        case 3:
            texture.loadFromFile("Sprites/UI/Coin.png");
            break;
        case 4:
            texture.loadFromFile("Sprites/UI/DoubleCoin.png");
            break;
    }
