...
Projectile::Projectile(double x,double y,int direction) : x(x),y(y),direction(direction)
{
    ...
    ProjectileTextures[0].loadFromFile("Sprites/PlayerSprites/Projectile/ProjectileOne.png");
    ProjectileTextures[1].loadFromFile("Sprites/PlayerSprites/Projectile/ProjectileTwo.png");
    ProjectileTextures[2].loadFromFile("Sprites/PlayerSprites/Projectile/ProjectileThree.png");
    ProjectileTextures[3].loadFromFile("Sprites/PlayerSprites/Projectile/ProjectileFour.png");
