...
RobotEnemy::RobotEnemy(double x, double y) {
    ...
    for (int i = 0; i < 4; i++)
        deathTextures.push_back(sf::Texture());
    beforeActivation.loadFromFile(Path::get()+"Sprites/Enemies/Robot/BeforeActivation/BeforeActivation.png");
    activateTextures[0].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Activate/ActivateOne.png");
    activateTextures[1].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Activate/ActivateTwo.png");
    activateTextures[2].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Activate/ActivateThree.png");
    activateTextures[3].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Activate/ActivateFour.png");
    activateTextures[4].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Activate/ActivateFive.png");
    idleTextures[0].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Idle/IdleOne.png");
    idleTextures[1].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Idle/IdleTwo.png");
    idleTextures[2].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Idle/IdleThree.png");
    idleTextures[3].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Idle/IdleFour.png");
    runTextures[0].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Run/RunOne.png");
    runTextures[1].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Run/RunTwo.png");
    runTextures[2].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Run/RunThree.png");
    runTextures[3].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Run/RunFour.png");
    shootTextures[0].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Shoot/ShootOne.png");
    shootTextures[1].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Shoot/ShootTwo.png");
    shootTextures[2].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Shoot/ShootThree.png");
    shootTextures[3].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Shoot/ShootFour.png");
    deathTextures[0].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Death/DeathOne.png");
    deathTextures[1].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Death/DeathTwo.png");
    deathTextures[2].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Death/DeathThree.png");
    deathTextures[3].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Death/DeathFour.png");
    deathTextures[4].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Death/DeathFive.png");
    deathTextures[5].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Death/DeathSix.png");
    deathTextures[6].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Death/DeathSeven.png");
    deathTextures[7].loadFromFile(Path::get()+"Sprites/Enemies/Robot/Death/DeathEight.png");
