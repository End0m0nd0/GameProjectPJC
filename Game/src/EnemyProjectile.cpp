...
EnemyProjectile::EnemyProjectile(double x, double y,double direction) : x(x), y(y), direction(direction)
{
    ...
    enemyProjectileTextures[0].loadFromFile(Path::get()+"Sprites/Enemies/EnemyProjectile/EnemyProjectileOne.png");
    enemyProjectileTextures[1].loadFromFile(Path::get()+"Sprites/Enemies/EnemyProjectile/EnemyProjectileTwo.png");
    enemyProjectileTextures[2].loadFromFile(Path::get()+"Sprites/Enemies/EnemyProjectile/EnemyProjectileThree.png");
    enemyProjectileTextures[3].loadFromFile(Path::get()+"Sprites/Enemies/EnemyProjectile/EnemyProjectileFour.png");
