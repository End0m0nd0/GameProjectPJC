...
Player::Player()
{
    ...
    playerTexture.loadFromFile(Path::get()+"Sprites/PlayerSprites/PlayerSprite.png");
    playerSprite.setTexture(playerTexture);
    x=400-getSpriteWidth()/2;
    y=400-getSpriteHeight()/2;
    playerRunTexture[0].loadFromFile(Path::get()+"Sprites/PlayerSprites/Run/PlayerRunOne.png");
    playerRunTexture[1].loadFromFile(Path::get()+"Sprites/PlayerSprites/Run/PlayerRunTwo.png");
    playerRunTexture[2].loadFromFile(Path::get()+"Sprites/PlayerSprites/Run/PlayerRunThree.png");
    playerRunTexture[3].loadFromFile(Path::get()+"Sprites/PlayerSprites/Run/PlayerRunFour.png");
    playerShootTexture[0].loadFromFile(Path::get()+"Sprites/PlayerSprites/Shoot/PlayerShootOne.png");
    playerShootTexture[1].loadFromFile(Path::get()+"Sprites/PlayerSprites/Shoot/PlayerShootTwo.png");
    playerShootTexture[2].loadFromFile(Path::get()+"Sprites/PlayerSprites/Shoot/PlayerShootThree.png");
    playerShootTexture[3].loadFromFile(Path::get()+"Sprites/PlayerSprites/Shoot/PlayerShootFour.png");
    playerDeathTexture[0].loadFromFile(Path::get()+"Sprites/PlayerSprites/Death/PlayerDeathOne.png");
    playerDeathTexture[1].loadFromFile(Path::get()+"Sprites/PlayerSprites/Death/PlayerDeathTwo.png");
    playerDeathTexture[2].loadFromFile(Path::get()+"Sprites/PlayerSprites/Death/PlayerDeathThree.png");
    playerDeathTexture[3].loadFromFile(Path::get()+"Sprites/PlayerSprites/Death/PlayerDeathFour.png");
    playerDeathTexture[4].loadFromFile(Path::get()+"Sprites/PlayerSprites/Death/PlayerDeathFive.png");
    playerDeathTexture[5].loadFromFile(Path::get()+"Sprites/PlayerSprites/Death/PlayerDeathSix.png");
    playerDeathTexture[6].loadFromFile(Path::get()+"Sprites/PlayerSprites/Death/PlayerDeathSeven.png");
}
