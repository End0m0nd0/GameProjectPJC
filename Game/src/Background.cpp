...
void Background::renderNew(){
    ...
    textures[0].loadFromFile(Path::get()+"Sprites/PlayerSprites/Floor/FloorOne.png");
    textures[1].loadFromFile(Path::get()+"Sprites/PlayerSprites/Floor/FloorTwo.png");
    textures[2].loadFromFile(Path::get()+"Sprites/PlayerSprites/Floor/FloorThree.png");
    textures[3].loadFromFile(Path::get()+"Sprites/PlayerSprites/Floor/FloorFour.png");
    textures[4].loadFromFile(Path::get()+"Sprites/PlayerSprites/Floor/FloorFive.png");
