...
HumanEnemy::HumanEnemy(double x, double y) {
    ...
    for (int i = 0; i < 5; i++)
        deathTextures.emplace_back();
    runTextures[0].loadFromFile("Sprites/Enemies/Human/Run/RunOne.png");
    runTextures[1].loadFromFile("Sprites/Enemies/Human/Run/RunTwo.png");
    runTextures[2].loadFromFile("Sprites/Enemies/Human/Run/RunThree.png");
    runTextures[3].loadFromFile("Sprites/Enemies/Human/Run/RunFour.png");
    shootTextures[0].loadFromFile("Sprites/Enemies/Human/Shoot/ShootOne.png");
    shootTextures[1].loadFromFile("Sprites/Enemies/Human/Shoot/ShootTwo.png");
    shootTextures[2].loadFromFile("Sprites/Enemies/Human/Shoot/ShootThree.png");
    shootTextures[3].loadFromFile("Sprites/Enemies/Human/Shoot/ShootFour.png");
    idleTextures[0].loadFromFile("Sprites/Enemies/Human/Idle/IdleOne.png");
    idleTextures[1].loadFromFile("Sprites/Enemies/Human/Idle/IdleTwo.png");
    idleTextures[2].loadFromFile("Sprites/Enemies/Human/Idle/IdleThree.png");
    deathTextures[0].loadFromFile("Sprites/Enemies/Human/Death/DeathOne.png");
    deathTextures[1].loadFromFile("Sprites/Enemies/Human/Death/DeathTwo.png");
    deathTextures[2].loadFromFile("Sprites/Enemies/Human/Death/DeathThree.png");
    deathTextures[3].loadFromFile("Sprites/Enemies/Human/Death/DeathFour.png");
    deathTextures[4].loadFromFile("Sprites/Enemies/Human/Death/DeathFive.png");
    deathTextures[5].loadFromFile("Sprites/Enemies/Human/Death/DeathSix.png");
    deathTextures[6].loadFromFile("Sprites/Enemies/Human/Death/DeathSeven.png");
    deathTextures[7].loadFromFile("Sprites/Enemies/Human/Death/DeathEight.png");
