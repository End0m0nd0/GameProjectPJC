...
UpgradeMenu::UpgradeMenu() : transparentRectangle(), transparentClassRectangle() {
    ...
    for(int i=0;i<4;i++){
        ...
        switch (i) {
            case 0:
                classTextures[i].loadFromFile("Sprites/PlayerSprites/ClassIcons/BerserkOne.png");
                ...
                break;
            case 1:
                classTextures[i].loadFromFile("Sprites/PlayerSprites/ClassIcons/SprinterOne.png");
                ...
                break;
            case 2:
                classTextures[i].loadFromFile("Sprites/PlayerSprites/ClassIcons/DevastatorOne.png");
                ...
                break;
            case 3:
                classTextures[i].loadFromFile("Sprites/PlayerSprites/ClassIcons/LuckyMan.png");
